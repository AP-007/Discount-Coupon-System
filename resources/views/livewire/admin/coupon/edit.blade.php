<form wire:submit.prevent="update">
    <div class="mt-4 mb-6 px-10">
        <!-- Modal title -->
        <p class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-300 px-20 text-center mt-10">
            Edit a Coupon
        </p>
        <!-- Modal description -->
        <p class="text-sm text-gray-700 dark:text-gray-400">
        <div class="px-10 py-10 mb-8 bg-white rounded-sm shadow-md dark:bg-gray-800">
        ...
        dark:border-gray-600 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray @endif  dark:bg-gray-700  dark:text-gray-300  form-input" />
                ...
                <label class="block text-sm">
                    ...
                    <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                        <input type="number" wire:model="discount_limit" class="block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"/>
                ...
                @elseif($discount_type == 1)
                    <div class="block text-sm mt-3">
                        <label class="block text-sm">
                            ...
                            <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                                <input type="number" wire:model="discount" class="block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"/>
                                <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
                                    Rs.
                                </div>
                            </div>
    ...
    <footer
        class="flex flex-col justify-end px-20 py-3 -mx-6 -mb-4 space-y-0 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800">
        <button type="button"
