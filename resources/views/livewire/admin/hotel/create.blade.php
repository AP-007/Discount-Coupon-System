<form wire:submit.prevent="store" class="px-10 py-5">
    <div class="mt-4 mb-6">
        <!-- Modal title -->
        ...
        <div class=" px-5 py-5 mb-8 bg-white rounded-sm shadow-md dark:bg-gray-800">
            <div class="grid grid-cols-2 gap-4">
                <div class="block text-sm">
                    <label for="name">
                        <span class="text-gray-700 dark:text-gray-400">Hotel Name <span class="text-red-600">*</span>
                        </span>
        ...
        @else
        dark:border-gray-600 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray @endif  dark:bg-gray-700  dark:text-gray-300  form-input"></textarea>
                    </label>
                    @error('description')
                        <span class="text-xs text-red-600 dark:text-red-400"> {{ $message }}</span>
                    @enderror
        ...
        dark:border-gray-600 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray @endif  dark:bg-gray-700  dark:text-gray-300  form-input" />
                ...
                <div class="block text-sm mt-3">
                    <label>
                        ...
                        <div
                            ...
                            <input type="text" wire:model.defer="municipality"
                ...
                <div class="block text-sm mt-3">
                    <label>
                        <span class="text-gray-700 dark:text-gray-400">Ward<span class="text-red-600">*</span></span>
                        <div
                            class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                            <input type="number" min="0" max="32" wire:model.defer="ward_no" min="0"
            ...
            dark:border-gray-600 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray @endif  dark:bg-gray-700  dark:text-gray-300  form-input" />
                ...
                <div class="block text-sm mt-3">
                    <label>
                        <span class="text-gray-700 dark:text-gray-400">Tole<span class="text-red-600">*</span></span>
                        <div
                            class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            ...
            dark:border-gray-600 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray @endif  dark:bg-gray-700  dark:text-gray-300  form-input" />
                ...
                <div class="block text-sm mt-3">
                    <label>
                        ...
                        <div
                            class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                            <input type="number" wire:model.defer="pan"
